...
public class Main {
    public static void main(String[] args) {
        ...
        orderController.handleUserRequest(1L, 2); // Valid order
        orderController.handleUserRequest(1L, 10); // Insufficient stock
        orderController.handleUserRequest(3L, 1); // Product not found
    }
}
